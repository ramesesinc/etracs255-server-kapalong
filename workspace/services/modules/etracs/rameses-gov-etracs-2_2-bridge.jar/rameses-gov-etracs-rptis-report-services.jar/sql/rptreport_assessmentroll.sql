...
SELECT
	...
	rp.cadastrallotno, rp.surveyno, rp.blockno, pc.code AS classcode, r.rputype, r.totalareasqm, r.totalareaha,
	r.totalmv, r.totalav, r.fullpin, f.prevtdno, f.memoranda, rp.barangayid 
FROM faas f
...
SELECT
	...
	f.administrator_name, f.administrator_address, 
	f.tdno, f.effectivityyear, f.prevtdno, 
	rp.cadastrallotno,  rp.surveyno, rp.blockno, pc.code AS classcode, r.totalareasqm, r.totalareaha,
